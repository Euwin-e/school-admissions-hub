        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-80">
            ...
            <DropdownMenuItem className="flex flex-col items-start gap-1 py-3">
              ...
              <span className="text-xs text-muted-foreground">Jean Dupont a soumis une candidature</span>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex flex-col items-start gap-1 py-3">
              <span className="font-medium">À traiter</span>
              <span className="text-xs text-muted-foreground">5 candidatures en attente de traitement</span>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex flex-col items-start gap-1 py-3">
              <span className="font-medium">Rappel</span>
              <span className="text-xs text-muted-foreground">Vérifiez les dossiers incomplets</span>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
          ...
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="flex items-center gap-2 px-2">
              ...
              <div className="hidden flex-col items-start text-left md:flex">
                ...
                <span className="text-xs text-muted-foreground">Agent d'Admission</span>
              </div>
            </Button>
          </DropdownMenuTrigger>
